...
def plot_boxes(results, frame,fps,classes):
    ...
    estimateSpeed(dictionaries,fps)       



    return frame

def estimateSpeed(dictonaries,fps):
...
def main(img_path=None, vid_path=None,vid_out = None):
    ...
    model =  torch.hub.load('./speed/home/yolov5-master', 'custom', source ='local', path='./speed/home/best.pt',force_reload=True) ### The repo is stored locally
    ...
    ### --------------- for detection on video --------------------
        ...
        while True:
            ...
            if ret  and frame_no %1 == 0:
                ...
                frame = plot_boxes(results, frame,fps,classes = classes)
...
main(vid_path="./speed/home/5.mp4",vid_out="vid_1.mp4") ### for custom video
